...
<script>
  ...
  grassFront.position.set(0, 0.02, 55);
  ...
  grassBack.position.set(0, 0.02, -55);
  ...
  grassLeft.position.set(-55, 0.02, 0);
  ...
  grassRight.position.set(55, 0.02, 0);
  groundGroup.add(grassRight);

  scene.add(groundGroup);

  // Raster für Übersicht
  ...
  function createBuyCircle(x, z, color, type) {
    ...
    const material = new THREE.MeshBasicMaterial({ color: color, opacity: 0.6, transparent: true });
